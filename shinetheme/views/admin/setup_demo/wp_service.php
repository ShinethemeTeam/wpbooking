...
<form method="post">
    ...
    <div class="setup-content">
        <h1 class="text-center"><?php esc_html_e("Service Setup","wp-booking-management-system") ?></h1>
        <div class="item_setup <?php echo esc_attr($is_tab) ?>">
            <table class="form-table wpbooking-settings ">
                <tbody>
                    ...
                    <th scope="row">
                        <label for="service_type_accommodation_review"><?php esc_html_e("Review:","wp-booking-management-system") ?></label>
                    </th>
                    <td>
                        <fieldset>
                            <ul class="padding-0">
                                <li class="">
                                    <label>
                                        ...
                                        <?php esc_html_e("Enable Review","wp-booking-management-system") ?>                          </label>
                                </li>
                                <li class="">
                                    <label>
                                        ...
                                        <?php esc_html_e("Allow user to review without booking","wp-booking-management-system") ?>                           </label>
                                </li>
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_accommodation_show_rate_review_button" class="form-control min-width-500">
                                        <?php esc_html_e("Show Rate (Help-full) button in each review?","wp-booking-management-system") ?>                         </label>
                                </li>
                                <li class="">
                                    <label>
                                        ...
                                        <?php esc_html_e("User can write review on their own listing?","wp-booking-management-system") ?>                            </label>
                                </li>
                                <li class="">
                                    <label>
                                        ...
                                        <?php esc_html_e("User can vote for their own review?","wp-booking-management-system") ?>                         </label>
                                </li>
                            </ul>
                        </fieldset>
