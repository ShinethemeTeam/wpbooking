                    ...
                    <td>
                        <fieldset>
                            <ul class="padding-0">
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_room_enable_review" checked="" class="form-control min-width-500">
                                        <?php esc_html_e("Enable Review","wpbooking") ?>                          </label>
                                </li>
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_room_review_without_booking" checked="" class="form-control min-width-500">
                                        <?php esc_html_e("Allow user to review without booking","wpbooking") ?>                           </label>
                                </li>
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_room_show_rate_review_button" class="form-control min-width-500">
                                        <?php esc_html_e("Show Rate (Help-full) button in each review?","wpbooking") ?>                         </label>
                                </li>
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_room_allowed_review_on_own_listing" checked="" class="form-control min-width-500">
                                        <?php esc_html_e("User can write review on their own listing?","wpbooking") ?>                            </label>
                                </li>
                                <li class="">
                                    <label>
                                        <input type="checkbox" name="wpbooking_service_type_room_allowed_vote_for_own_review" class="form-control min-width-500">
