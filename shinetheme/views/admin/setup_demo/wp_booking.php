...
<form method="post">
    ...
    <div class="setup-content">
        <h1 class="text-center"><?php esc_html_e("Booking Setup","wp-booking-management-system") ?></h1>
        <div class="item_setup <?php echo esc_html($is_tab) ?>">
            <table class="form-table wpbooking-settings">
                <tbody>
                <tr class="">
                    <th scope="row">
                        <label for=""><?php esc_html_e("Allow Guest to Checkout?","wp-booking-management-system") ?>:</label>
                    </th>
                    <td>
                       ...
                       <?php esc_html_e("Allow Guest to Checkout?","wp-booking-management-system") ?>
                    </td>
                </tr>
                <tr class="wpbooking_">
                    <th scope="row" colspan="2">
                        <h3 class="margin_0"><?php esc_html_e("Captcha Google","wp-booking-management-system") ?></h3>
                    </th>
                </tr>
                <tr class="wpbooking_allow_captcha_google_checkout wpbooking-form-group  ">
                    <th scope="row">
                        <label for="allow_captcha_google_checkout"><?php esc_html_e("Allow Captcha Google to be Checked out?:","wp-booking-management-system") ?></label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e("Allow Captcha Google to be Checked out?","wp-booking-management-system") ?>
                        </label>
                ...
                <tr class="wpbooking_google_key_captcha">
                    <th scope="row">
                        <label for="google_key_captcha"><?php esc_html_e("Google key","wp-booking-management-system") ?></label>
                    </th>
                    <td>
                ...
                <tr class="wpbooking_google_secret_key_captcha">
                    <th scope="row">
                        <label for="google_secret_key_captcha"><?php esc_html_e("Google secret key","wp-booking-management-system") ?></label>
                    </th>
                    <td>
