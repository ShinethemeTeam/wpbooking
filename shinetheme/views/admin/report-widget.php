<div class="wpbooking_dashboard_widget">
    <div class="table table_left table_current_month">
            <table>
                <thead>
                <tr>
                    <td colspan="2"><?php esc_html_e('Current Month','wp-booking-management-system') ?></td>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="first t monthly_earnings"><?php esc_html_e('Earnings','wp-booking-management-system') ?></td>
                    <td class="b b-earnings" ><?php echo WPBooking_Currency::format_money($current_month_earning) ?></td>
                </tr>
                <tr>
                    <td class="first t monthly_sales"><?php esc_html_e('Sales','wp-booking-management-system')?></td>
            ...
            <table>
                <thead>
                <tr>
                    <td colspan="2"><?php esc_html_e('Last Month','wp-booking-management-system')?></td>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="first t earnings"><?php esc_html_e('Earnings','wp-booking-management-system') ?></td>
                    <td class="b b-last-month-earnings"><?php echo WPBooking_Currency::format_money($last_month_earning) ?></td>
                </tr>
                <tr>
                    <td class="first t sales">
                        <?php esc_html_e('Sales','wp-booking-management-system')?>						</td>
    ...
    <div class="table table_right table_today">
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <?php esc_html_e('Today','wp-booking-management-system')?>							</td>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="t sales"><?php esc_html_e('Earnings','wp-booking-management-system') ?></td>
    ...
    <div class="table table_right table_totals">
        <table>
            <thead>
            <tr>
                <td colspan="2"><?php esc_html_e('Totals','wp-booking-management-system')?></td>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td class="t earnings"><?php esc_html_e('Earnings','wp-booking-management-system') ?></td>
                <td class="last b b-earnings" ><?php echo WPBooking_Currency::format_money($total_earning) ?></td>
            </tr>
            <tr>
                <td class="t sales"><?php esc_html_e('Sales','wp-booking-management-system')?></td>
