    ...
    <div class="wb-content">
        ...
        <div class="control">
            ...
            <div class="all-extension">
                <a href="<?php echo esc_url('http://188.166.251.178/wpbooking/?post_type=download&s=&no_scroll');?>" class="button button-primary"><?php echo esc_html__('Browse all extensions','wpbooking'); ?></a>
            </div>
        </div>
        <div class="content">
