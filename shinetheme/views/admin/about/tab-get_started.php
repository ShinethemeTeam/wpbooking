...
<div class="wb-control">
    ...
    <div class="wb-desc <?php echo ( count( $tabs ) > 1 ) ? '' : 'full-width'; ?>">
        <p><?php echo wp_kses( esc_html__( 'We are supporting you with four main settings to create a booking system.', 'wpbooking' ), [ 'strong' => [] ] ) ?></p>
        <p>
            <?php echo esc_html__( 'HomePage:', 'wpbooking' ); ?>
            <a href="https://wpbooking.org"
               target="_blank"><?php echo esc_html__( 'WPBooking.org', 'wpbooking' ); ?></a>
        </p>
        <p>
            <?php echo esc_html__( 'Document:', 'wpbooking' ); ?>
            <a href="http://shinetheme.com/demosd/documentation/wpbooking/?cat=15"
               target="_blank"><?php echo esc_html__( 'Getting Started', 'wpbooking' ); ?></a> <?php echo esc_html__( 'or for developer', 'wpbooking' ); ?>
            <a href="http://shinetheme.com/demosd/documentation/wpbooking/?cat=8" target="_blank"><?php echo esc_html__( 'API & Hooks', 'wpbooking' ) ?></a>
        </p>
    ...
    <div class="footer">
        ...
        <div class="link">
            <a href="<?php echo esc_url( 'https://wpbooking.org' ); ?>"
               target="_blank"><?php echo esc_html__( 'Need any Help?', 'wpbooking' ) ?></a>
            <a href="<?php echo esc_url( 'https://wpbooking.org/pricing-fqa' ); ?>"
               target="_blank"><?php echo esc_html__( 'FAQ', 'wpbooking' ) ?></a>
            <a href="<?php echo esc_url( 'https://wpbooking.org' ); ?>"
               target="_blank"><?php echo esc_html__( 'Submit a Ticket?', 'wpbooking' ) ?></a>
        </div>
    </div>
</div>
