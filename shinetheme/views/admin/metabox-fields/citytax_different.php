        ...
        <div class="st-metabox-content-wrapper">
            <div class="form-group">
                <select class="form-control widefat small" name="citytax_excluded">
                    <option <?php selected("",get_post_meta($post_id, 'citytax_excluded', TRUE)) ?> value=""><?php esc_html_e("No",'wp-booking-management-system') ?></option>
                    <option <?php selected("yes_included",get_post_meta($post_id, 'citytax_excluded', TRUE)) ?> value="yes_included"><?php esc_html_e("Yes, Included",'wp-booking-management-system') ?></option>
                    <option <?php selected("yes_not_included",get_post_meta($post_id, 'citytax_excluded', TRUE)) ?> value="yes_not_included"><?php esc_html_e("Yes, Not included",'wp-booking-management-system') ?></option>
                </select>
            ...
            <div class="form-group">
                ...
                <div class="tax_input_col_right">
                    ...
                    <select class="form-control widefat small" name="citytax_unit">
                        ...
                        <option <?php selected("percent",get_post_meta($post_id, 'citytax_unit', TRUE)) ?> value="percent"><?php esc_html_e("Percent (%)",'wp-booking-management-system') ?></option>
                    </select>
