        ...
        <div class="st-metabox-content-wrapper">
            <div class="form-group">
                <label class="from-group-col">
                    <?php esc_html_e('from (optional)','wp-booking-management-system') ?>
                    <select class="form-control small" name="checkout_from">
                        <option value=""><?php esc_html_e('Please Select','wp-booking-management-system') ?></option>
                ...
                <label class="from-group-col">
                    <?php esc_html_e('to','wp-booking-management-system') ?>
