                ...
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard americanexpress"><?php esc_html_e("American Express","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard visa"><?php esc_html_e("Visa","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label <?php if (array_key_exists("americanexpress",$old_data)) echo 'checked' ?> >
                            ...
                            <span class="creditcard euromastercard"><?php esc_html_e("Euro/Mastercard","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard dinersclub"><?php esc_html_e("Diners Club","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard jcb"><?php esc_html_e("JCB","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard maestro"><?php esc_html_e("Maestro","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard discover"><?php esc_html_e("Discover","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard unionpaydebitcard"><?php esc_html_e("UnionPay debit card","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard unionpaycreditcard"><?php esc_html_e("UnionPay credit card","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
                <div class="wpbooking-col-sm-6">
                    <div class="form-group">
                        <label >
                            ...
                            <span class="creditcard bankcard"><?php esc_html_e("Bankcard","wp-booking-management-system") ?></span>
                        </label>
                    </div>
                </div>
            </div>
