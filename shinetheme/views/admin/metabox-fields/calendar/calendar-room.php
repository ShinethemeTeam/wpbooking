                        ...
                        <div class="calendar-room-form-item full-width">
                            ...
                            <div class="calendar-input-icon mt20">
                                <label class="calendar-label wb-radio-input"><input data-style="iradio_square-orange"
                                                                                    ...
                                                                                    value="forever" <?php if ( $property_available_for == 'forever' or !$property_available_for ) echo 'checked' ?> > <?php echo esc_html__( 'Forever', 'wpbooking' ); ?>
                                </label>
                                <label class="calendar-label wb-radio-input"><input data-style="iradio_square-orange"
                                                                                    ...
                                                                                    name="property_available_for"
                                                                                    data-post-id="<?php echo esc_attr( $post_id ); ?>"
                                                                                    value="specific_periods" <?php if ( $property_available_for == 'specific_periods' ) echo 'checked' ?> > <?php echo esc_html__( 'For specific periods', 'wpbooking' ); ?>
                                </label>
                            </div>
                        </div>
                    </div>
