...
<tr class="<?php echo esc_html($class) ?>" <?php echo esc_attr($data_class) ?>>
    ...
    <td>
        <table>
            <tr>
                <td>
                    <label><?php esc_html_e("Currency","wp-booking-management-system") ?></label>
                    ...
                    <i class="wpbooking-desc"><?php esc_html_e("Currency","wp-booking-management-system") ?></i>
                </td>
                <td>
            ...
            <tr class="<?php echo esc_html($name) ?>[position]">
                <td>
                    <label for="symbol"><?php esc_html_e("Position of Symbol","wp-booking-management-system") ?></label>
