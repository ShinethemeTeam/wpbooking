...
<div class="<?php echo esc_html($class) ?>">
    <div class="traveler-build-group ">
        ...
        <textarea class="item" data-name-shortcode="<?php echo esc_attr($parent) ?>" name="<?php echo balanceTags($data['name']) ?>" id="<?php echo balanceTags($data['name']) ?>"><?php echo balanceTags($data['value']) ?></textarea>
