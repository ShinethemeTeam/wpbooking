...
<div class="<?php echo esc_html($class) ?>">
    <div class="wpbooking-build-group ">
        ...
        <textarea data-type="content" class="item" data-name-shortcode="<?php echo esc_attr($parent) ?>" name="<?php echo balanceTags($data['name']) ?>" id="<?php echo balanceTags($data['name']) ?>"><?php echo balanceTags($data['value']) ?></textarea>
