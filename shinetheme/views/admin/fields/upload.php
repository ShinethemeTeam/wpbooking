...
<tr class="<?php echo esc_html($class) ?>" <?php echo esc_attr($data_class) ?>>
    ...
    <td>
        ...
        <button class="btn button btn_remove_demo_image button-secondary" type="button" name=""><?php esc_html_e("Remove","wpbooking") ?></button>
        <br>
        ...
        <br>
        <button id="btn_upload_media" class="btn button button-primary btn_upload_media" type="button" name=""><?php esc_html_e("Upload","wpbooking") ?></button>
