...
<form class="wb-form-edit-profile" action="" method="post">
	...
	<h3 class="tab-page-title">
		<?php esc_html_e("Edit Profile",'wp-booking-management-system') ?>
	</h3>

    <div class="wb-edit-profile-wrap">
        <h3 class="tab-page-title">
            <?php esc_html_e("Information",'wp-booking-management-system') ?>
        </h3>
        <div class="container-fluid item_profile">
            <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_fist_name"><?php esc_html_e('First Name','wp-booking-management-system') ?> <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_last_name"><?php esc_html_e('Last Name','wp-booking-management-system') ?> <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_email"><?php esc_html_e('Email Address','wp-booking-management-system') ?> <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_phone"><?php esc_html_e('Phone','wp-booking-management-system') ?> <span class="required">*</span></label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="u_address"><?php esc_html_e('Address','wp-booking-management-system') ?> <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_postcode"><?php esc_html_e('Postcode / ZIP','wp-booking-management-system') ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="u_apt_unit"><?php esc_html_e('Apt / Unit','wp-booking-management-system') ?></label>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button type="submit" class="wb-btn wb-btn-default"><?php esc_html_e('Save','wp-booking-management-system') ?></button>
                </div>
            </div>
