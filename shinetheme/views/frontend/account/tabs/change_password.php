...
<h3 class="tab-page-title">
    <?php esc_html_e("Change Password",'wp-booking-management-system') ?>
</h3>
    ...
    <div class="container-fluid">
        <div class="row border">
            ...
            <div class="col-md-9 text-info">
                <?php esc_html_e("Tips: Use 8 characters at least. Don't re-use passwords from other websites or include obvious words like your name or email.","wp-booking-management-system") ?>
            </div>
            <div class="col-md-12">
                <?php if(WPBooking_Input::post('action')=='wpbooking_change_password') echo wpbooking_get_message(); ?>
                <button type="submit" class="btn wb-btn-default"><?php esc_html_e('Update password','wp-booking-management-system') ?></button>
            </div>
        </div>
    </div>
</form>