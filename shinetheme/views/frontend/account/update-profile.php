...
<div class="row">
    ...
    <div class="col-sm-6">
        <form action="" method="post">
            ...
            <h4 class="form-title"><?php esc_html_e( 'Update Profile', 'wp-booking-management-system' ) ?></h4>

            <div class="form-group">
                <label><?php esc_html_e( 'Avatar', 'wp-booking-management-system' ) ?></label>
                <input type="hidden" class="form-control" id="u_avatar" name="u_avatar"
                       placeholder="<?php esc_html_e( 'Display Name', 'wp-booking-management-system' ) ?>"
                ...
                <div class="upload-avatar">
                    <div class="input-group">
							<span class="input-group-btn">
								<span class="btn btn-primary btn-file">
									<?php esc_html_e( 'Browse...', 'wp-booking-management-system' ) ?> <input type="file"
                                                                                           class="upload_input">
								</span>
							</span>
                    ...
                    <p class="help-block"><?php esc_html_e( 'Image formats : jpg, png, gif . Image size is 800x600 and max file size is 2MB', 'wp-booking-management-system' ) ?></p>
            ...
            <div class="form-group">
                <label for="u_display_name"><?php esc_html_e( 'Display Name', 'wp-booking-management-system' ) ?></label>
            ...
            <div class="form-group">
                <label for="u_email"><?php esc_html_e( 'Email', 'wp-booking-management-system' ) ?></label>
                <input type="text" class="form-control" id="u_email" name="u_email"
                       placeholder="<?php esc_html_e( 'Email', 'wp-booking-management-system' ) ?>"
                       value="<?php echo esc_attr( WPBooking_Input::post( 'u_email', $current_user->user_email ) ) ?>">
            </div>
            <div class="form-group">
                <label for="u_phone"><?php esc_html_e( 'Phone Number', 'wp-booking-management-system' ) ?></label>
                <input type="text" class="form-control" id="u_phone" name="u_phone"
                       placeholder="<?php esc_html_e( 'Phone Number', 'wp-booking-management-system' ) ?>"
            ...
            <button type="submit" class="btn btn-default"><?php esc_html_e( 'Submit', 'wp-booking-management-system' ) ?></button>
    ...
    <div class="col-sm-6">
        <form action="" method="post">
            ...
            <h4 class="form-title"><?php esc_html_e( 'Change Password', 'wp-booking-management-system' ) ?></h4>

            <div class="form-group">
                <label for="u_password"><?php esc_html_e( 'Old Password', 'wp-booking-management-system' ) ?></label>
                <input type="password" class="form-control" id="u_password" name="u_password"
                       placeholder="<?php esc_html_e( 'Display Name', 'wp-booking-management-system' ) ?>">
            </div>
            <div class="form-group">
                <label for="u_new_password"><?php esc_html_e( 'New Password', 'wp-booking-management-system' ) ?></label>
                <input type="password" class="form-control" id="u_new_password" name="u_new_password"
                       placeholder="<?php esc_html_e( 'Display Name', 'wp-booking-management-system' ) ?>">
            </div>
            <div class="form-group">
                <label for="u_re_new_password"><?php esc_html_e( 'Confirm New Password', 'wp-booking-management-system' ) ?></label>
