        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="u_avatar" name="u_avatar"
                       placeholder="<?php esc_html_e( 'Display Name', 'wpbooking' ) ?>"
                    ...
                    <div class="input-group">
							<span class="input-group-btn">
								<span class="btn btn-primary btn-file">
									<?php esc_html_e( 'Browse...', 'wpbooking' ) ?> <input type="file"
                                                                                           class="upload_input">
								</span>
							</span>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="u_email" name="u_email"
                       placeholder="<?php esc_html_e( 'Email', 'wpbooking' ) ?>"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="u_phone" name="u_phone"
                       placeholder="<?php esc_html_e( 'Phone Number', 'wpbooking' ) ?>"
