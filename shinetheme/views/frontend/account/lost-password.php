...
<form class="wb-form-lost-password" action="" method="post">
    <input type="hidden" name="action" value="wpbooking_lost_password">
    ...
    <div class="form-group-wrap">
        <div class="form-group">
            ...
            <input class="form-control" id="username_email" name="username_email" value="">
        </div>
        <div class="form-group">
    ...
    <?php wp_create_nonce('wb-lost-password'); ?>
