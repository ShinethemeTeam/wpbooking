...
<form action="" method="post" id="wpbooking-register-form" class="login-register-form">
	...
	<div class="form-group-wrap">
		<div class="form-group">
			<label for="reg-login" class="control-label"><?php esc_html_e('Username','wp-booking-management-system') ?> <span class="required">*</span></label>
		...
		<div class="form-group">
			<label for="input-email" class="control-label"><?php esc_html_e('Email','wp-booking-management-system') ?> <span class="required">*</span></label>
		...
		<div class="form-group">
			<label for="input-repassword" class="control-label"><?php esc_html_e('Re-type Password','wp-booking-management-system') ?> <span class="required">*</span></label>
		...
		<div class="form-group">
			<label class="accept-term">
					<input type="checkbox" name="term_condition" <?php (!$reset?checked(WPBooking_Input::post('term_condition'),1):'') ?> value="1"><?php printf(esc_html__('Accept %s','wp-booking-management-system'),sprintf('<a href="%s" target="_blank">%s</a>',$term_link,esc_html__('Term & Condition','wp-booking-management-system'))); ?>
			</label>
		</div>
		<button type="submit" class="wb-btn wb-btn-default wb-disabled"><?php esc_html_e('Register','wp-booking-management-system') ?></button>
	</div>
	<?php
