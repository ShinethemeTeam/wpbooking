            ...
            <div class="control left">
                <?php
                    ...
                    if ( !empty( $max_guests ) ) {
                        ...
                        <?php esc_html_e( "Max", "wp-booking-management-system" ) ?><?php echo esc_attr( $max_guests ); ?>
                    <?php } ?>
            </div>
            <div class="control">
                <?php
                ...
                if ( !empty( $check_in ) and !empty( $check_out ) and $is_minimum_stay ) {
                    ...
                    <div class="room-extra">
                        <?php if ( !empty( $list_extra ) ) { ?>
                            <span class="btn_extra"><?php esc_html_e( "Extra services", "wp-booking-management-system" ) ?></span>
                        <?php } ?>
                    </div>
                <?php } else { ?>
                    <button onclick="return false"
                            class="wb-btn wb-btn-default wb-btn-sm button_show_price is_single_search_result"><?php esc_html_e( "Show Price", "wp-booking-management-system" ) ?></button>
                <?php } ?>
        </div>
        <?php
        $number_night = $diff;
        ...
        <div class="modal-content">
            ...
            <div class="info col-4">
                <div class="item ">
                    <?php
                        ...
                        if ( !empty( $max_guests ) ) {
                            ...
                            <span><?php esc_html_e( "Max Guest:", "wp-booking-management-system" ) ?><?php echo esc_attr( $max_guests ); ?><?php if ( $max_guests > 1 ) esc_html_e( "guests", "wp-booking-management-system" ); else esc_html_e( "guest", "wp-booking-management-system" ) ?></span>
                        <?php } ?>
                </div>
                <div class="item space">
                    ...
                    <span>
                             <?php esc_html_e( "Room Size:", "wp-booking-management-system" ) ?>
                             <?php
                                 echo esc_attr( $room_size );
                                 $room_measunit = get_post_meta( $hotel_id, 'room_measunit', true );
                                 if ( $room_measunit == 'feet' )
