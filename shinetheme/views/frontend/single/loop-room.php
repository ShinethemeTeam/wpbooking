            ...
            <div class="control left">
                <?php
                    ...
                    if ( !empty( $max_guests ) ) {
                        ...
                        <?php esc_html_e( "Max", "wpbooking" ) ?><?php echo esc_attr( $max_guests ); ?>
                    <?php } ?>
            </div>
            <div class="control">
                <?php
            ...
            <?php
                ...
                <?php } else { ?>
                    <button onclick="return false"
                            class="wb-btn wb-btn-default wb-btn-sm button_show_price is_single_search_result"><?php esc_html_e( "Show Price", "wpbooking" ) ?></button>
                <?php } ?>
        </div>
        <?php
                ...
                <div class="item ">
                    <?php
                        ...
                        if ( !empty( $max_guests ) ) {
                            ...
                            <span><?php esc_html_e( "Max Guest:", "wpbooking" ) ?><?php echo esc_attr( $max_guests ); ?><?php if ( $max_guests > 1 ) esc_html_e( "guests", "wpbooking" ); else esc_html_e( "guest", "wpbooking" ) ?></span>
                        <?php } ?>
                </div>
