...
if(!empty($order_data['rooms'])){
    ...
    <div class="review-order-item-table wpbooking-bootstrap">
        <table>
            <thead>
            <tr>
                <td width="50%" class="col-title"><?php echo esc_html__('Rooms','wp-booking-management-system') ?></td>
                <td class="text-center"><?php echo esc_html__('Price','wp-booking-management-system') ?> (<?php echo WPBooking_Currency::get_current_currency('currency') ?>)</td>
                <td class="text-center" width="15%"><?php echo esc_html__('Number','wp-booking-management-system') ?></td>
                <td class="text-center"><?php echo esc_html__('Total','wp-booking-management-system') ?> (<?php echo WPBooking_Currency::get_current_currency('currency') ?>)</td>
            </tr>
            </thead>
            <tbody>
            <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="room-info">
                                        ...
                                        <?php
                                        if(!empty($v['raw_data'])){ ?>
                                            <span class="btn_detail_checkout"><?php echo esc_html__("Details","wp-booking-management-system") ?> <i class="fa fa-caret-down" aria-hidden="true"></i>
</span>
                                        <?php } ?>
