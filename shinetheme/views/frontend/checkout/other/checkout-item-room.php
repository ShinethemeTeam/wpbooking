            ...
            foreach($cart['rooms'] as $k=>$v){
                ...
                <tr class="room-<?php echo esc_attr($k) ?> ">
                    <td width="5%"  class="text-center">
                        ...
                        <a class="delete-cart-item tooltip_desc" onclick="return confirm('<?php esc_html_e('Do you want to delete it?','wpbooking') ?>')" href="<?php echo esc_url(add_query_arg(array('delete_cart_item'=>$k),$booking->get_checkout_url())) ?>">
