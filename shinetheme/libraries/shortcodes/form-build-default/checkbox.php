...
if(function_exists( 'traveler_add_field_form_builder' )) {
    traveler_add_field_form_builder( array(
            ...
            "name"    => 'traveler_booking_check_box' ,
...
if(!function_exists( 'traveler_sc_booking_check_box' )) {
    function traveler_sc_booking_check_box( $attr , $content = false )
    {
        $data = shortcode_atts(
            array(
                'title'          => '' ,
        ...
        Traveler_Admin_Form_Build::inst()->traveler_add_item_field_shortcode($title ,$name,array('data'=>$data,'rule'=>''));
        return $list_item;
    }
}
add_shortcode( 'traveler_booking_check_box' , 'traveler_sc_booking_check_box' );
