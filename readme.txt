=== WP Booking ===
Author URI: http://wpbooking.org
Plugin URI: http://wpbooking.org
Contributors: wpbooking, shinetheme
Donate link: http://wpbooking.org/donate/
...
Complete solution for accommodation and tour booking with WordPress.
...
* Visitor after book can see booking history
...
3. Create new service by click on the ÔServicesÕ menu entry
4. Click on 'Add New' to create new a service
5. For detailed setup introductions, visit http://wpbooking.org/documentations



== Frequently Asked Questions ==

= What is a ÒServiceÓ in WPBooking? =

Each kind of data like Accommodation, Tour in WPBooking called a Service. You can base on your requirement to create new a service and its unlimited.

= How can I add room for an accommodation? =

You can going to Room Details tab and will see the button ÒCreate New RoomÓ. Click on it to add new room for this accommodation.
...
Please see http://www.wpbooking.org for more information and ask your questions there!
...
1. Settings general
2. Settings payment
3. Settings email preview
4. List bookings
5. Email content to buyer
6. List booking
7. Booking history
8. Booking statistic with chart
9. Cart checkout
10. Accommodation details
11. Room in accommodation
12. Search results
13. Room details
...
* WPBooking is born. This release was only available via download at https://wpbooking.org or via GitHub. We consider Dec 16, 2016, WPBookingÕs birthday.
